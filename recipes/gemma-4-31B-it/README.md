...
| KV cache | measured per variant at 262144: `h100-1` 365,231 tokens, `h200-1` 894,418, `rtx-1` 400,876, giving 1.39, 3.41 and 1.53 full-length requests. Cost is not linear in context, because 50 of the 60 layers keep only a 1024-token sliding window |
