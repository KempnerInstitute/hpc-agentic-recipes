...
a million tokens, which the NVFP4 build of this same base model and Kimi-K3 also reach. The price is
hardware: at 756 GB the weights need two H200 nodes, and two nodes need pipeline parallelism.
