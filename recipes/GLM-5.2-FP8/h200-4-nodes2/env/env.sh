# Runtime environment for GLM-5.2-FP8 on two H200 nodes. Source, do not execute.
...
KEY_NAME=GLM-5.2-FP8-h200-4-nodes2
...
# required: a silent NCCL failure across nodes cannot be diagnosed from the server log alone
