...
# so install the cu129 release wheel with a matching torch backend. ray[default] is not optional here:
# this recipe spans two nodes and uses vLLM's Ray executor, and the dashboard extras are what ray
# start needs to bring up a cluster.
