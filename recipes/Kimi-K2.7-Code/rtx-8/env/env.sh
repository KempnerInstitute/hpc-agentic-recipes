# Runtime environment for Kimi-K2.7-Code on one RTX PRO 6000 Blackwell node. Source, do not execute.
...
# required: 64 shards of weights plus first-time JIT exceeds the 600s default readiness timeout
