#!/usr/bin/env bash
# Start the Ray head on this node, for Kimi-K2.7-Code across two H200 nodes.
#   bash recipes/Kimi-K2.7-Code/h200-4-nodes2/ray_head.sh <head_ip> [ray_port]
...
#
# Two changes from the pre-restructure scripts/ray_head.sh, both required by the restructure: it
