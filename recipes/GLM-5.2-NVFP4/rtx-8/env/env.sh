# Runtime environment for GLM-5.2-NVFP4 on one RTX PRO 6000 Blackwell node. Source, do not execute.
...
# sm_120 sparse-MLA backend passes, but no flashinfer-cubin 0.6.15 exists, so the version check has
